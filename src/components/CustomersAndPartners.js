    ...
    <div className="flex flex-col items-center justify-center min-h-screen mb-20">
      ...
      <div className="flex flex-col gap-4 items-center">
        <div className="flex gap-4">
          ...
          <img src="asset/Group 59.svg" width="150px" alt="" />
          <img src="asset/Group 60.svg" width="150px" alt="" />
          <img src="asset/Group 61.svg" width="150px" alt="" />
        ...
        <div className="flex gap-4">
          ...
          <img src="asset/Group 69.svg" width="150px" alt="" />
          <img src="asset/Group 70.svg" width="150px" alt="" />
          <img src="asset/4.svg" width="150px" alt="" />
        ...
        <div className="mt-10">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <img src="asset/Group 99.svg" width="150px" alt="" />
          </div>
        </div>
      </div>
    </div>
